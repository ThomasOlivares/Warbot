  ...
  if ([energy] of a > n * explorer-cost) [
    ...
    repeat n [
      ...
      hatch-Explorers 1 [
        ...
        hatch-Perceptions 1 [
          set color [color] of a
          set myRange 2 * explorer-perception
          set agt myself
          ask myself [ set percept self ]
          set size 0
        ]
  ...
  if ([energy] of a > n * rocket-launcher-cost) [
    ...
    repeat n [
      ...
      hatch-RocketLaunchers 1 [
        ...
        hatch-Perceptions 1 [
          set color [color] of a
          set myRange 2 * rocket-launcher-perception
          set agt myself
          ask myself [ set percept self ]
          set size 0
        ]
  ...
  if ([energy] of a > n * harvester-cost) [
    ...
    repeat n [
      ...
      hatch-Harvesters 1 [
        ...
        hatch-Perceptions 1 [
          set color [color] of a
          set myRange 2 * harvester-perception
          set agt myself
          ask myself [ set percept self ]
          set size 0
        ]
...
to go-missile
  ...
  ifelse myRange < 0
    ...
    [ fd speed set myRange myRange - speed
    ]
end
